...

{
    public  class Class1
    {
        public  static void Main(string[] args)
        {
            ...
            //    @"D:\C#\Wisky\Unilog.Reso\Reso.Unilog.API\DataService",
            //    "localhost",
            //    "UniLogDev", "saisam", "Katie123", "Models", "UnilogDevContext", true
            //    );
            ...
            FileHelper.ChangeTextToCsFile(
                @"D:\C#\Wisky\Unilog.Reso\Reso.Unilog.API\DataService\ServiceModels\Gen",
                @"D:\C#\Wisky\Unilog.Reso\Reso.Unilog.API\DataService\ServiceModels", 4
                );
