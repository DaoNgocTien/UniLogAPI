...
namespace DataService.Models
{
	...
	public partial class UnitOfWork : UnilogDevContext, IUnitOfWork
	{
		...
		public UnitOfWork(IServiceProvider scope, DbContextOptions<UnilogDevContext> options) : base(options)
		{
			Scope = scope;
			Context = this;
		}
