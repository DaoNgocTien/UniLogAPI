...
namespace DataService.Model.ViewModel
{
    public  static partial class Enums
    {
        ...
        {
            [Display(Name = "Physical Web Server")]
            Physical = 1,
            [Display(Name = "Cloud Web Server")]
            Cloud = 2,
            [Display(Name = "Repo Server")]
            Repo = 3,
            [Display(Name = "Database Server")]
            Database = 4
        }
        public  enum ServerOSEnum
        {
            [Display(Name = "Windows Os")]
            Windows = 1,
            [Display(Name = "Linux Os")]
            Linux = 2,
            [Display(Name = "Azure Git")]
            Azure = 3,
            [Display(Name = "GitHub")]
            GitHub = 4,
            [Display(Name = "GitLab")]
            GitLab = 5,
            [Display(Name = "Other Git")]
            OtherGit = 6,
            [Display(Name = "Microsoft SQL")]
            MSSQL = 7,
            [Display(Name = "MongoDB")]
            MongoDB = 8,
            [Display(Name = "FirebaseDB")]
            FirebaseDB = 9,
            [Display(Name = "Other DB")]
            OtherDB = 10
        }
        #endregion

        #region SystemInstance
        public  enum SystemInstanceStatusEnum
        {
        ...
        {
            [Display(Name = "Log Information")]
            Information = 1,
            [Display(Name = "Log Warning")]
            Warning = 2,
            [Display(Name = "Log Error")]
            Error = 3
        }

        public  enum LogServerityEnum
        {
