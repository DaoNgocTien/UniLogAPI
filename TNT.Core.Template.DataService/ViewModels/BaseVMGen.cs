...
namespace TNT.Core.Template.DataService.ServiceModels
{
    public class BaseVMGen : FileGen
    {
        ...
        private void GenerateNamespace()
        {
            ...
            Namespace.Signature = "namespace " + Data.ProjectName + ".ServiceModels";
        ...
        {
            var IServiceModel = new ContainerGen();
            IServiceModel.Signature = "public partial interface IServiceModel";
            IServiceModel.Body.Add(
                new StatementGen(
                    "void CopyFrom(object src);",
                    "void CopyTo(object dest);",
                    "ET To<ET>();"));
            NamespaceBody.Add(IServiceModel, new StatementGen(""));

            IBaseVM = new ContainerGen();
            IBaseVM.Signature = "public partial interface IBaseServiceModel<E>: IServiceModel";
        ...
        {
            var BaseServiceModel = new ContainerGen();
            BaseServiceModel.Signature = "public abstract partial class BaseServiceModel<E>: IBaseServiceModel<E>";

            var c0 = new ContainerGen();
            c0.Signature = "public BaseServiceModel(E entity)";
            c0.Body.Add(new StatementGen("FromEntity(entity);"));

            var c1 = new ContainerGen();
            c1.Signature = "public BaseServiceModel()";
            ...
            NamespaceBody.Add(BaseServiceModel, new StatementGen(""));
        }
