    ...
    public class ContextParser
    {
        ...
        private void SetEntitiesInfo()
        {
            ...
            foreach (var eT in eTypes)
            {
                ...
                eInfo.VMClass = eInfo.EntityName + "ServiceModel";
        ...
        private void SetNavPropInfo(EntityInfo eInfo, IEntityType eType)
        {
            ...
            foreach (var p in props)
            {
                ...
                if (p.IsCollection())
                {
                    navColProp.Add(name, "IEnumerable<" + p.ClrType.GetGenericArguments().FirstOrDefault().Name + "ServiceModel>");
                }
                else
                {
                    navProp.Add(name, type + "ServiceModel");
                }
            }
        }
